"""fooooooooood_25357 URL Configuration
...
admin.site.site_header = "Fooooooooood"
admin.site.site_title = "Fooooooooood Admin Portal"
admin.site.index_title = "Fooooooooood Admin"

# swagger
api_info = openapi.Info(
    title="Fooooooooood API",
    default_version="v1",
    description="API documentation for Fooooooooood App",
)
